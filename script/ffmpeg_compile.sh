...
PKG_CONFIG_PATH="$pkg_prefix_mingw/lib/pkgconfig" ASFLAGS="-O5" \
	...
	--extra-cflags="-O2 -MP -arch:$vc_inc_arch -Gw -Gy -GS- -favor:$favor_arch -I$pkg_prefix_win\include" \
	--extra-cxxflags="-O2 -MP -arch:$vc_inc_arch -Gw -Gy -GL -GS- -favor:$favor_arch -I$pkg_prefix_win\include" \
