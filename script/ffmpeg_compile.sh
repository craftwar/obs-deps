...
PKG_CONFIG_PATH="$pkg_prefix_mingw/lib/pkgconfig" ASFLAGS="-O5" \
	...
	--extra-cflags="-O2 -MP -arch:$vc_inc_arch -Gw -Gy -GS- -Qspectre- -favor:$favor_arch -Zc:__cplusplus -Zc:inline $cl_cpu_options -I$pkg_prefix_win\include" \
	--extra-cxxflags="-O2 -MP -arch:$vc_inc_arch -Gw -Gy -GL -GS- -Qspectre- -favor:$favor_arch -Zc:__cplusplus $cl_cpu_options -I$pkg_prefix_win\include" \
